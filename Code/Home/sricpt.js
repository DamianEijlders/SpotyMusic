...
fetch('../songs.json')
    ...
    >
      ...
      >
        <img id="songimage"
          class="h-20 mr-3 rounded mt-2 mb-2"
          src="${song.img_file}"
          alt="Video preview"
        />
        <span id="songtitle" class="text-sm"></span>
      </div>
      <div class="flex items-center w-full">
        <div class="w-full">
          ...
          <div class="flex items-center justify-between space-x-2">
            <span id="duration-currenttime" class="text-sm font-medium text-gray-500 dark:text-gray-400"
              >3:45</span
            >
            ...
            <span id="duration" class="text-sm font-medium text-gray-500 dark:text-gray-400"
              >5:00</span
            >
          </div>
        </div>
